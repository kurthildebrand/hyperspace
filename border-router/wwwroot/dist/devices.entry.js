...
/* Global Variables ------------------------------------------------------------------------------ */
var update_stream   = new _microsoft_signalr__WEBPACK_IMPORTED_MODULE_0__.HubConnectionBuilder().withUrl("/s/stream").build();
var firmware_stream = new _microsoft_signalr__WEBPACK_IMPORTED_MODULE_0__.HubConnectionBuilder().withUrl("/s/firmware").build();
var firmware_files  = [];
var devices         = [];
...
/******/ })()
;
//# sourceMappingURL=devices.entry.js.map